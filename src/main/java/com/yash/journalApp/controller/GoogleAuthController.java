...
public class GoogleAuthController {
    ...
    @GetMapping("callback")
    @Operation(summary = "Google Authentication (OAuth2)")
    public ResponseEntity<?> handleGoogleCallback(@RequestParam String code){
        try {
            ...
            headres.setContentType(MediaType.APPLICATION_FORM_URLENCODED);

            HttpEntity<MultiValueMap<String, String>> request = new HttpEntity<>(params, headres);
